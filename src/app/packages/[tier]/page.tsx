    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-indigo-500/6 rounded-full blur-3xl" />
          ...
          <div className="lg:grid lg:grid-cols-[1fr_300px] lg:gap-16 lg:items-start">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-950/50">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-600/25 hover:bg-indigo-700 hover:scale-[1.02] transition-all"
              >
            ...
            <div className="hidden lg:flex flex-col rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden">
              <div className="bg-indigo-600 px-6 py-5">
                ...
                <p className="text-sm text-indigo-200 mt-1">{pkg.tagline}</p>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {pkg.includes.map((item) => (
              ...
              >
                <div className="flex-shrink-0 mt-0.5 h-5 w-5 rounded-full bg-indigo-100 dark:bg-indigo-950 flex items-center justify-center">
        ...
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-10 lg:items-start">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900 p-5">
                <Quote className="h-5 w-5 text-indigo-300 dark:text-indigo-700 mb-3" />
              ...
              <div className="space-y-6">
                {pkg.process.map((step) => (
                  <div key={step.step} className="flex gap-5">
                    <div className="flex-shrink-0 h-10 w-10 rounded-full bg-indigo-600 flex items-center justify-center text-xs font-bold text-white tabular-nums z-10 relative">
                      {step.step}
                    </div>
      ...
      <section className="py-14 md:py-20 border-t border-zinc-100 dark:border-zinc-900">
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-700 p-8 md:p-14 text-center relative overflow-hidden">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-sm font-bold text-indigo-700 shadow-xl hover:bg-indigo-50 hover:scale-[1.02] transition-all"
            >
              <Calendar className="h-4 w-4" />
