...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/ads`, lastModified: new Date("2026-08-08"), priority: 0.8 },
    ...
    { url: `${SITE_URL}/work/titandoors`, lastModified: new Date("2026-06-02"), priority: 0.7 },
    { url: `${SITE_URL}/privacy`, lastModified: new Date("2026-08-07"), priority: 0.3 },
    { url: `${SITE_URL}/terms`, lastModified: new Date("2026-03-16"), priority: 0.3 },
    { url: `${SITE_URL}/cookies`, lastModified: new Date("2026-08-07"), priority: 0.3 },
    ...blogEntries,
  ];
}
